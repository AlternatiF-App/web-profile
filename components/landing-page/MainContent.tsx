  ...
  return (
    <div className="bg-main pt-16 lg:pt-28 font-sora hide-scroll-bar">
        <div className="w-full 2xl:w-10/12 2xl:mx-auto lg:flex px-0 lg:px-8">
            <div className="w-full lg:w-1/2 bg-primary lg:bg-transparent text-white px-6 py-10 lg:py-6 lg:px-4 2xl:px-20 2xl:py-28">
            ...
            <div className="w-full lg:w-1/2 px-6 py-14 lg:py-8 2xl:py-20 lg:px-10">
