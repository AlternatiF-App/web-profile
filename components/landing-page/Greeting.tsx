  ...
  return (
    <div className="w-full 2xl:w-10/12 2xl:ml-auto lg:flex font-sora px-6 lg:px-8 lg:py-20">
        <div className="w-full lg:w-1/2 2xl:px-10">
            <span className="block text-base lg:text-xl">Sambutan</span>
            <h1 className="text-4xl lg:text-7xl font-medium pt-2">Kepala Sekolah</h1>
            <p className="font-light pt-4 w-full 2xl:w-[82%] text-justify lg:text-left text-base lg:text-xl">
            ...
            <h2 className="font-bold pt-4 text-base lg:text-xl">- Uswida, S. Pd</h2>
        </div>
        <div className="w-full lg:w-1/2 py-10 lg:px-10 lg:py-20">
