...
function SampleNextArrow (props:any) {
  const { onClick } = props
  return (
    <div className="absolute right-8 lg:right-10 h-auto z-40 inset-y-1/2 -mt-4 lg:-mt-8 xl:-mt-4 opacity-70 hover:opacity-100 transition-opacity duration-500 shadow-md">
...
function SamplePrevArrow (props:any) {
  const { onClick } = props
  return (
    <div className="absolute left-8 lg:left-10 h-auto z-40 inset-y-1/2 -mt-4 lg:-mt-8 xl:-mt-4 opacity-70 hover:opacity-100 transition-opacity duration-500 shadow-md">
